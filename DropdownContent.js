...
import { Picker, Text, View, Dimensions, ScrollView, Button, TextInput, StyleSheet} from "react-native";
import {
...
class DropdownContent extends Component{
  constructor(props){
    super(props);
    this.state = {selected_option_index: 0}
  }

  toggle(num){
    var that = this;
    this.setState({selected_option_index:num})
  }
  ...
  renderContent(){
    var that = this;
      ...
      <View style = {{width:"100%",height:"100%", alignItems:'center', justifyContent:'center', backgroundColor:"rgb(242,242,247)"}}>
        <Text>
           {that.props["panel" + that.state.selected_option_index]}
        </Text>
      </View>
      )
  ...
  render() {
    ...
    return (
      <View style={styles.app}>
        <TitleText text = {"Panels"}></TitleText>
          <DropdownContent
